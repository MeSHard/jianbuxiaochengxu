...
var _sfc_main = {
    ...
    computed: {
        ...
        otherBorderColor: function otherBorderColor() {
            var lightColor = common_vendor.colorGradient(this.color, "#ffffff", 100)[80];
            if (this.mode === "circle") {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    return common_vendor.e({
        ...
        d: common_vendor.f($data.array12, function(item, index, i0) {
            return {
                a: index
            };
        })
    } : {}, {
        e: common_vendor.n("uv-loading-icon__spinner--".concat(_ctx.mode)),
        f: _ctx.color,
...
var Component = /*   */ common_vendor._export_sfc(_sfc_main, [ [ "render", _sfc_render ], [ "__scopeId", "data-v-daf2e960" ] ]);
