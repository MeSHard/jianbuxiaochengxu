...
if (!Array) {
    ...
    var _easycom_uv_text2 = common_vendor.resolveComponent("uv-text");
...
var _easycom_uv_text = function _easycom_uv_text() {
    return "../uv-text/uv-text.js";
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    return common_vendor.e({
        ...
        h: common_vendor.n("uv-avatar__image--".concat(_ctx.shape)),
        i: $data.avatarUrl || _ctx.defaultUrl,
        j: _ctx.mode,
        k: common_vendor.o(function() {
            return $options.errorHandler && $options.errorHandler.apply($options, arguments);
        }),
        l: common_vendor.s({
            width: _ctx.$uv.addUnit(_ctx.size),
            height: _ctx.$uv.addUnit(_ctx.size)
        ...
        d: _ctx.icon,
        f: _ctx.text,
        m: common_vendor.n("uv-avatar--".concat(_ctx.shape)),
        n: common_vendor.s({
...
var Component = /*   */ common_vendor._export_sfc(_sfc_main, [ [ "render", _sfc_render ], [ "__scopeId", "data-v-0a88435c" ] ]);
